...
namespace AssetEasy
{
    public partial class frmVendorCategories : Form
    {
        ...
        private DbV_VendorCategoriesTree dbV_CategoriesTree = new DbV_VendorCategoriesTree();
        private DbV_VendorCategoriesTree dbV_CategoriesTreeCodePath = new DbV_VendorCategoriesTree();
        private DbT_VendorCategories dbT_Categories = new DbT_VendorCategories();
        private DbT_VendorCategories dbT_CategoriesParent = new DbT_VendorCategories();
        ...
        private void GetCategoryCodePath(string CategoryID, ref DbV_VendorCategoriesTree dbVCodePath)
        {
        ...
        private BasicDAL.ExecutionResult GetSelectedCategory(string ID, ref DbT_VendorCategories dbT, ref DbV_VendorCategoriesTree dbVCodePath)
        {
