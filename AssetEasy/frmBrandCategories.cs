...
namespace AssetEasy
{
    public partial class frmBrandCategories : Form
    {
        ...
        private DbV_BrandCategoriesTree dbV_BrandCategoriesTreeCodePath = new DbV_BrandCategoriesTree();
        private DbT_BrandCategories dbT_BrandCategories = new DbT_BrandCategories();
        private DbT_BrandCategories dbT_BrandCategoriesParent = new DbT_BrandCategories();
        ...
        private void InitDataContext(bool ForceFormInit = false)
        {
            ...
            this.dbT_BrandCategories.DataBinding = BasicDAL.DataBoundControlsBehaviour.BasicDALDataBinding;
            this.dbT_BrandCategoriesParent.Init(this.DbConfig);
            this.dbV_BrandCategoriesTree.Init(this.DbConfig);
            this.dbV_BrandCategoriesTreeCodePath.Init(this.DbConfig);
            ...
            this.dbT_BrandCategories.DbC_id.BoundControls.Add(this.txt_Categories_ID, "text");
            this.dbT_BrandCategories.DbC_description.BoundControls.Add(this.txt_Categories_Description, "text");
            this.dbT_BrandCategories.DbC_mnemoniccode.BoundControls.Add(this.txt_Categories_MnemonicCode, "text");
            this.dbT_BrandCategories.DbC_notes.BoundControls.Add(this.txt_Categories_Notes, "text");
            ...
            this.dataNavigator1.DbObject = this.dbT_BrandCategories;
            ...
            this.LoadComboBrandClassesTreeView();
            this.LoadBrandCategoryForm();
        ...
        private void LoadBrandTreeView(bool SelectFirsNode = true)
        {
            ...
            AssetEasy.Utilities.TreeViewLoad(ref this.treeView, DBNull.Value, null, this.dbV_BrandCategoriesTree.DataTable, "ID", "ParentID", "Description", "CodePath", "Level, CodePath");
        ...
        private void LoadComboCategoryTreeView(string selectedNodeName = "")
        {
            ...
            AssetEasy.Utilities.TreeViewComboBoxLoad(ref this.tvc_Categories_ParentID, DBNull.Value, null, this.dbV_BrandCategoriesTree.DataTable, "ID", "ParentID", "Description", "CodePath", "Level, CodePath");
        ...
        private void LoadComboBrandClassesTreeView(string selectedNodeName = "")
        {
            this.dbV_BrandClassesTree.FiltersGroup.Clear();
            this.dbV_BrandClassesTree.Open(true);
            this.tvc_BrandClassID .Nodes.Clear();
            this.tvc_BrandClassID.Nodes.Add("0", "0 - NO CLASS");
            AssetEasy.Utilities.TreeViewComboBoxLoad(ref tvc_BrandClassID, DBNull.Value, null, this.dbV_BrandClassesTree.DataTable, "ID", "ParentID", "Description", "CodePath", "Level, CodePath");
            if (selectedNodeName != null)
            {
                TreeNode node = AssetEasy.Utilities.GetTreeNodeByName(this.tvc_BrandClassID.Nodes, selectedNodeName);
                if (node != null)
                    this.tvc_BrandClassID.SelectedItem = node;
            }

        }

        private string GetBrandCategoryCodePath(string CategoryID, ref DbV_BrandCategoriesTree dbVCodePath)
        {
            ...
            {
                return dbVCodePath.DbC_codepath.Value.ToString();
            }
            else
            {
                return "";//= dbVCodePath.DbC_codepath.Value.ToString();
        ...
        private void dataNavigator1_eSave()
        {
            ...
            if (this.dataNavigator1.DataGridActive == false)
            {
                ...
                //if (this.tvc_Categories_ParentID.SelectedItem != null)
                //{
                //    this.dbT_BrandCategories.DbC_parentid.Value = Convert.ToInt32(NewParent);
                //}
                //else
                //{
                //    this.dbT_BrandCategories.DbC_parentid.Value = DBNull.Value;
                //}

                this.dbT_BrandCategories.DbC_parentid.Value = NewParent;
                if (tvc_BrandClassID .SelectedItem !=null)
                    this.dbT_BrandCategories.DbC_brandclassid .Value = Convert.ToInt32(this.tvc_BrandClassID.SelectedItem.Name);
                    //this.dbT_BrandCategories.DbC_brandclassid.Value = this.tvc_BrandClassID.SelectedItem.Name;


                this.dbT_BrandCategories.Update();
                NodeName = this.txt_Categories_ID.Text;
        ...
        private void dataNavigator1_eUndo()
        {
            if (this.dataNavigator1.DataGridActive == false)
            {
                ...
                TreeNode node = AssetEasy.Utilities.GetTreeNodeByName(this.tvc_Categories_ParentID.Nodes, this.dbT_BrandCategories.DbC_parentid.Value.ToString());
                if (node != null)
                {
                    this.tvc_Categories_ParentID.SelectedItem = node;
                }
        ...
        private void LoadBrandCategoryForm()
        {
            if (this.treeView.SelectedNode  == null)
                return;
            string Name = treeView.SelectedNode.Name;
            //TreeNode ParentNode = null;
            this.txt_NodeFullPath.Text = treeView.SelectedNode.FullPath.ToString();
            this.GetSelectedBrandCategory(Name, ref dbT_BrandCategories);
            //if (this.GetSelectedBrand(Name, ref dbT_BrandCategories).Failed==false)
            {
                this.txt_Categories_FullMnemonicCode.Text = this.GetBrandCategoryCodePath(this.dbT_BrandCategories.DbC_id.Value.ToString(), ref this.dbV_BrandCategoriesTreeCodePath);
                //ParentNode = AssetEasy.Utilities.GetTreeNodeByName(this.tvc_Categories_ParentID.Nodes, this.dbT_BrandCategories.DbC_parentid.Value.ToString());
                this.tvc_Categories_ParentID.SelectedItem = AssetEasy.Utilities.GetTreeNodeByName(this.tvc_Categories_ParentID.Nodes, this.dbT_BrandCategories.DbC_parentid.Value.ToString());
                this.tvc_BrandClassID.SelectedItem = AssetEasy.Utilities.GetTreeNodeByName(this.tvc_BrandClassID.Nodes, this.dbT_BrandCategories.DbC_brandclassid.Value.ToString());
            }

        }
        private BasicDAL.ExecutionResult GetSelectedBrandCategory(string ID, ref DbT_BrandCategories dbT)
        {
