...
namespace AssetEasy
{
    public partial class frmVAT : Form
    {
        ...
        public DbT_VAT dbT_VAT = new DbT_VAT();
        ...
        private void InitDataContext(bool ForceFormInit = false)
        {
            ...
            this.dbT_VAT.DataBinding = BasicDAL.DataBoundControlsBehaviour.BasicDALDataBinding;
            this.dbT_VAT.Init(this.DbConfig);

            this.dbT_VAT.DbC_id.BoundControls.Add(this.txt_vat_id, "text", BasicDAL.BindingBehaviour.ReadAddNew);
           
            //this.dbT_Vendors.DbC_geolocation.BoundControls.Add(this.txt_owners_geolocation, "text");
            this.dbT_VAT.DbC_mnemoniccode.BoundControls.Add(this.txt_vat_mnemoniccode, "text");
            this.dbT_VAT.DbC_description.BoundControls.Add(this.txt_vat_description, "text");
            this.dbT_VAT.DbC_rate.BoundControls.Add(this.txt_vat_rate, "text");
            this.dbT_VAT.DbC_notes.BoundControls.Add(this.txt_owners_notes, "text");
            this.dbT_VAT.Open(true);

            this.dataNavigator1.DbObject = this.dbT_VAT;
        ...
        private void qbe_VAT()
        {
            DbT_VAT QBEDbObject = new DbT_VAT();
            ...
            QBEForm.QueryDbObject = this.dbT_VAT;
            QBEForm.AutoLoadAll = true;
            QBEForm.UseExactSearchForString = false;
            QBEForm.DbColumnsMapping.Add(QBEDbObject.DbC_id, this.dbT_VAT.DbC_id);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string x = this.dbT_VAT.SaveAsJson();
