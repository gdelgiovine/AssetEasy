...
namespace AssetEasy
{
    public partial class frmOperatorCategories : Form
    {

        public AppConfig appConfig;

        private BasicDAL.DbConfig DbConfig;
        private DbV_OperatorCategoriesTree dbV_CategoriesTree = new DbV_OperatorCategoriesTree();
        private DbV_OperatorCategoriesTree dbV_CategoriesTreeCodePath = new DbV_OperatorCategoriesTree();
        private DbT_OperatorCategories dbT_Categories = new DbT_OperatorCategories();
        private DbT_OperatorCategories dbT_CategoriesParent = new DbT_OperatorCategories();
        private bool FormInit = false;
        private bool DataNavigatorHandlerInitialized = false;

        public frmOperatorCategories()
        {
            InitializeComponent();
        }
        ...
        private void InitDataContext(bool ForceFormInit = false)
        {
            ...
            this.dbT_Categories.Init(this.DbConfig);
            this.dbT_Categories.DataBinding = BasicDAL.DataBoundControlsBehaviour.BasicDALDataBinding;
            this.dbT_CategoriesParent.Init(this.DbConfig);
            this.dbV_CategoriesTree.Init(this.DbConfig);
            this.dbV_CategoriesTreeCodePath.Init(this.DbConfig);
            ...
            this.dbT_Categories.DbC_id.BoundControls.Add(this.txt_Categories_ID, "text");
            this.dbT_Categories.DbC_description.BoundControls.Add(this.txt_Categories_Description, "text");
            this.dbT_Categories.DbC_mnemoniccode.BoundControls.Add(this.txt_Categories_MnemonicCode, "text");
            this.dbT_Categories.DbC_notes.BoundControls.Add(this.txt_Categories_Notes, "text");
            ...
            this.dataNavigator1.DbObject = this.dbT_Categories;
        ...
        private void LoadCategoryTreeView(bool SelectFirsNode = true)
        {
            ...
            this.dbV_CategoriesTree.FiltersGroup.Clear();
            this.dbV_CategoriesTree.Open(true);
            this.treeView.Nodes.Clear();
            AssetEasy.Utilities.TreeViewLoad(ref this.treeView, DBNull.Value, null, this.dbV_CategoriesTree.DataTable, "ID", "ParentID", "Description", "CodePath", "Level, CodePath");
        ...
        private void LoadComboCategoryTreeView(string selectedNodeName = "")
        {
            ...
            AssetEasy.Utilities.TreeViewComboBoxLoad(ref this.tvc_Categories_ParentID, DBNull.Value, null, this.dbV_CategoriesTree.DataTable, "ID", "ParentID", "Description", "CodePath", "Level, CodePath");
        ...
        private void GetCategoryCodePath(string CategoryID, ref DbV_OperatorCategoriesTree dbVCodePath)
        {
        ...
        private void dataNavigator1_eSave()
        {
            ...
            if (this.dataNavigator1.DataGridActive == false)
            {
                ...
                if (this.tvc_Categories_ParentID.SelectedItem != null)
                {
                    this.dbT_Categories.DbC_parentid.Value = Convert.ToInt32(NewParent);
                }
                else
                {
                    this.dbT_Categories.DbC_parentid.Value = DBNull.Value;
                }

                this.dbT_Categories.Update();
                NodeName = this.txt_Categories_ID.Text;
        ...
        private void dataNavigator1_eUndo()
        {
            if (this.dataNavigator1.DataGridActive == false)
            {
                ...
                TreeNode node = AssetEasy.Utilities.GetTreeNodeByName(this.tvc_Categories_ParentID.Nodes, this.dbT_Categories.DbC_parentid.Value.ToString());
                if (node != null)
                {
                    this.tvc_Categories_ParentID.SelectedItem = node;
                }
        ...
        private void treeView_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            if (this.GetSelectedCategory(Name, ref dbT_Categories, ref dbV_CategoriesTreeCodePath).Failed == false)
            {
        ...
        private BasicDAL.ExecutionResult GetSelectedCategory(string ID, ref DbT_OperatorCategories dbT, ref DbV_OperatorCategoriesTree dbVCodePath)
        {
            ...
            if (er.Failed == false)
            {
                this.GetCategoryCodePath(dbT.DbC_id.Value.ToString(), ref dbVCodePath);
            }
            return er;
        ...
        private void frmOperatorCategories_Load(object sender, EventArgs e)
        {
