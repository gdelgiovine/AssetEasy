...
namespace AssetEasy
{
    ...
    {   
        ...
        public DbT_Vendors dbT_Vendors = new DbT_Vendors();
        ...
        private void InitDataContext(bool ForceFormInit = false)
        {
            ...
            this.dbT_Vendors.DataBinding = BasicDAL.DataBoundControlsBehaviour.BasicDALDataBinding;
            this.dbT_Vendors.Init(this.DbConfig);

            this.dbT_Vendors.DbC_id.BoundControls.Add(this.txt_owners_id, "text", BasicDAL.BindingBehaviour.ReadAddNew);
            this.dbT_Vendors.DbC_city.BoundControls.Add(this.txt_owners_city, "text");
            this.dbT_Vendors.DbC_country.BoundControls.Add(this.txt_owners_country, "text");
            this.dbT_Vendors.DbC_name.BoundControls.Add(this.txt_owners_name, "text");
            this.dbT_Vendors.DbC_state.BoundControls.Add(this.txt_owners_state, "text");
            this.dbT_Vendors.DbC_zip.BoundControls.Add(this.txt_owners_zip, "text");
            this.dbT_Vendors.DbC_phonenumber.BoundControls.Add(this.txt_owners_phonenumber, "text");
            this.dbT_Vendors.DbC_email.BoundControls.Add(this.txt_owners_email, "text");
            //this.dbT_Vendors.DbC_geolocation.BoundControls.Add(this.txt_owners_geolocation, "text");
            this.dbT_Vendors.DbC_mnemoniccode.BoundControls.Add(this.txt_owners_mnemoniccode, "text");
            this.dbT_Vendors.DbC_address.BoundControls.Add(this.txt_owners_address, "text");
            //this.dbT_Vendors.DbC_notes.BoundControls.Add(this.txt_owners_notes, "text");
            this.dbT_Vendors.Open(true);

            this.dataNavigator1.DbObject = this.dbT_Vendors;
        ...
        private void qbe_Vendors()
        {
            ...
            QBEForm.QueryDbObject = this.dbT_Vendors;
            QBEForm.AutoLoadAll = true;
            QBEForm.UseExactSearchForString = false;
            QBEForm.DbColumnsMapping.Add(QBEDbObject.DbC_id, this.dbT_Vendors.DbC_id);
