...
namespace AssetEasy 
{
    public partial class frmLocations : Form
    {
        ...
        public DbT_Locations dbT_Locations = new DbT_Locations();
        ...
        private void InitDataContext(bool ForceFormInit = false)
        {
            ...
            this.dbT_Locations.DataBinding = BasicDAL.DataBoundControlsBehaviour.BasicDALDataBinding;
            this.dbT_Locations.Init(this.DbConfig);

            this.dbT_Locations.DbC_id .BoundControls.Add(this.txt_locations_id, "text", BasicDAL.BindingBehaviour.ReadAddNew);
            this.dbT_Locations.DbC_city.BoundControls.Add(this.txt_locations_city, "text");
            this.dbT_Locations.DbC_country.BoundControls.Add(this.txt_locations_country, "text");
            this.dbT_Locations.DbC_name .BoundControls.Add(this.txt_locations_name, "text");
            this.dbT_Locations.DbC_state.BoundControls.Add(this.txt_locations_state, "text");
            this.dbT_Locations.DbC_zip.BoundControls.Add(this.txt_locations_zip, "text");
            this.dbT_Locations.DbC_phonenumber.BoundControls.Add(this.txt_locations_phonenumber, "text");
            this.dbT_Locations.DbC_email.BoundControls.Add(this.txt_locations_email, "text");
            this.dbT_Locations.DbC_geolocation.BoundControls.Add(this.txt_locations_geolocation, "text");
            this.dbT_Locations.DbC_mnemoniccode.BoundControls.Add(this.txt_locations_mnemoniccode, "text");
            this.dbT_Locations.DbC_address.BoundControls.Add(this.txt_locations_address, "text");
            this.dbT_Locations.DbC_notes.BoundControls.Add(this.txt_locations_notes, "text");
            this.dbT_Locations.Open(true);

            this.dataNavigator1.DbObject = this.dbT_Locations;
        ...
        private void qbe_Locations()
        {
            ...
            QBEForm.QueryDbObject = this.dbT_Locations ;
            QBEForm.AutoLoadAll = true;
            QBEForm.UseExactSearchForString = false;
            QBEForm.DbColumnsMapping.Add(QBEDbObject.DbC_id, this.dbT_Locations.DbC_id);
        ...
        private void frmLocations_Accelerator(object sender, AcceleratorEventArgs e)
        {
            e.Handled = true;
        ...
        private void button1_Click(object sender, EventArgs e)
         {
            ...
            if (this.dataNavigator1.FKeyEnabled==true)
            {
                this.dataNavigator1.FKeyEnabled = false;
            }
            else
            {
