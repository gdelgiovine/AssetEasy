...
namespace AssetEasy
{
    public partial class frmIssueCategories  : Form
    {

        public AppConfig appConfig;

        private BasicDAL.DbConfig DbConfig;
        private DbV_IssueCategoriesTree dbV_CategoriesTree = new DbV_IssueCategoriesTree();
        private DbV_IssueCategoriesTree dbV_CategoriesTreeCodePath = new DbV_IssueCategoriesTree();
        private DbT_IssueCategories dbT_Categories = new DbT_IssueCategories();
        private DbT_IssueCategories dbT_CategoriesParent = new DbT_IssueCategories();
        private bool FormInit = false;
        private bool DataNavigatorHandlerInitialized = false;

        public frmIssueCategories()
        {
            InitializeComponent();
        }
        ...
        private void GetCategoryCodePath(string CategoryID, ref DbV_IssueCategoriesTree dbVCodePath)
        {
        ...
        private BasicDAL.ExecutionResult GetSelectedCategory(string ID, ref DbT_IssueCategories dbT, ref DbV_IssueCategoriesTree dbVCodePath)
        {
        ...
        private void frmIssueCategories_Load(object sender, EventArgs e)
        {
