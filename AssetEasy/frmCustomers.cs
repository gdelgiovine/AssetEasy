...
namespace AssetEasy
{
    public partial class frmCustomers : Form
    {
        ...
        public DbT_Customers dbT_Customers = new DbT_Customers();
        ...
        private void InitDataContext(bool ForceFormInit = false)
        {
            ...
            this.dbT_Customers.Init(DbConfig);
            this.dbT_Customers.DataBinding = BasicDAL.DataBoundControlsBehaviour.BasicDALDataBinding;
            this.dbT_Customers.Init(this.DbConfig);

            this.dbT_Customers.DbC_id.BoundControls.Add(this.txt_customers_id, "text", BasicDAL.BindingBehaviour.ReadAddNew);
            
            
            this.dbT_Customers.DbC_fullname.BoundControls.Add(this.txt_customers_fullname, "text");
            this.dbT_Customers.DbC_firstname.BoundControls.Add(this.txt_customers_state, "text");
            this.dbT_Customers.DbC_lastname.BoundControls.Add(this.txt_customers_zip, "text");
            this.dbT_Customers.DbC_phonenumber.BoundControls.Add(this.txt_customers_phonenumber, "text");
            this.dbT_Customers.DbC_emailaddress.BoundControls.Add(this.txt_customers_emailaddress, "text");
            this.dbT_Customers.DbC_titlename.BoundControls.Add(this.txt_customers_geolocation, "text");
            this.dbT_Customers.DbC_mnemoniccode .BoundControls.Add(this.txt_customers_mnemoniccode, "text");
            this.dbT_Customers.DbC_phonenumber.BoundControls.Add(this.txt_customers_address, "text");
            this.dbT_Customers.DbC_notes.BoundControls.Add(this.txt_customers_notes, "text");
            this.dbT_Customers.Open(true);

            this.dataNavigator1.DbObject = this.dbT_Customers;
        ...
        private void qbe_Vendors()
        {
            ...
            QBEForm.QueryDbObject = this.dbT_Customers;
            QBEForm.AutoLoadAll = true;
            QBEForm.UseExactSearchForString = false;
            QBEForm.DbColumnsMapping.Add(QBEDbObject.DbC_id, this.dbT_Customers.DbC_id);
